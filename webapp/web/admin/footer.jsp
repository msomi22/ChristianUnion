...
%>
     ...
     <div>
     <footer>
    <p class="pull-left">Copyright  &copy; <%= Calendar.getInstance().get(Calendar.YEAR)%> Maasai Mara University Christiannion - Developed By : <a href="http://www.facebook.com/fastech.co.ke" target="_blank">FasTech Solutions Ltd</a> </p>
    </footer>
    </div>
