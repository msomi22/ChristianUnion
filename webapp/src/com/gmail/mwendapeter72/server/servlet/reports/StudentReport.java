...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           //Paragraph p= new Paragraph("MMUCU REPORT", new Font(FontFamily.HELVETICA, 22));
          // Paragraph p1 = new Paragraph(selector.process("Maasai Mara University Christain Union(MMUCU)  \n"));
          ...
          // Paragraph p15 = new Paragraph("Printed on:	\t "+new Date());
