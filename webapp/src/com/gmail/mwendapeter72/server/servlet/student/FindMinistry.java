 ...
 *
 */
public class FindMinistry extends HttpServlet{
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
	   ...
	   HttpSession session = request.getSession(true);
	    ...
	    if(StringUtils.isBlank(AdmNo)){
		   ...
		   paramHash.put("nameMinistry", s.getFirstName()+" "+s.getLastName()+" "+s.getSurName());
   ...
   /**
	 * 
	 */
	private static final long serialVersionUID = 6882696003962690335L;
}
