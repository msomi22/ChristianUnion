 ...
 *
 */
public class LeadersRegister extends StorableBean{
	...
	/**
	 * @param subPosition the subPosition to set
	 */
	...
	public String toString(){
		...
		builder.append("Leaders register [ getUuid() =");
