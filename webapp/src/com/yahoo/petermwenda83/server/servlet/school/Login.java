...
public class Login extends HttpServlet {
	...
	final String ERROR_WRONG_SCH_PASS = "SchoolAccount Password or Username Incorrect.";
	final String ERROR_WRONG_SCH_USERNAME = "SchoolAccount Password or Username Incorrect.";
